...
<head>
	...
	<title>Job Click - Employee Profile</title>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="about" class=" form-control" placeholder="Enter your short description ..." style="height: 200px;"><?php echo "$mydesc"; ?></textarea>
													</div>
