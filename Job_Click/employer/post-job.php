...
<head>
	...
	<title>Job Click - Post Job</title>
    ...
    <meta property="og:image:alt" content="Job Click" />
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="responsiblities" required class="form-control " placeholder="Enter responsiblities..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="requirements" required class="form-control" placeholder="Enter requirements..." style="height: 200px;"></textarea>
													</div>
